...
class RevenueController extends Controller
{
    ...
    public function index()
    {
      ...
      return view('finance.revenue.revenue', compact('revenues', 'archives'));
    }

    public function revenueListForAdmin()
    {
      $revenues= Revenue::latest();
      ...
      return view('admin.reports.revenue', compact('revenues', 'archives'));
    }
    ...
    {
        return view('finance.revenue.editRevenue',compact('revenue',$revenue));
    }
