        ...
        <hr>
         ...
         <div class="row form-group">
            ...
            <div class="col-md-3">
              ...
              <input type="text"  name="name" value="{{$employee->name}}" class="form-control" placeholder="اسم" required>
            </div>
            <div class="col-md-3">
              <label  for="University Name" style="color:black">تخلص</label>
              <input type="text"  name="lName" value="{{$employee->lName}}" class="form-control" placeholder="تخلص" required>
            </div>
            <div class="col-md-3">
              <label  for="University Name" style="color:black">اسم پدر</label>
              <input type="text"  name="fName" value="{{$employee->fName}}" class="form-control" placeholder="اسم پدر" required>
            </div>
            <div class="col-md-3">
         ...
         <div class="row form-group">
          ...
          <div class="col-md-4">
            ...
            <input type="number"  name="tazkira" value="{{$employee->tazkira}}" class="form-control" placeholder="نمبر تذکره" required>
          </div>
          <div class="col-md-4">
            <label  for="University Name" style="color:black">شروع قرارداد</label>
            <input type="date"  name="start" value="{{$employee->start}}" class="form-control" placeholder="شروع قرارداد" required>
          </div>
         </div>
         ...
         <div class="row form-group">
           <div class="col-md-4">
             ...
             <input type="date"  name="end" value="{{$employee->end}}" class="form-control" placeholder="ختم قرارداد" required>
           </div>
           <div class="col-md-4">
             <label  for="University Name" style="color:black">TIN</label>
             <input type="number" min="1"  name="TIN" value="{{$employee->TIN}}" class="form-control" placeholder="TIN" required>
           </div>
            <div class="col-md-4" >
              <label  for="Field of Study" style="color:black">تلفن </label>
              <input type="text" name="phone" value="{{$employee->phone}}" placeholder="(999) 999-9999" data-mask="(999) 999-9999" class="form-control" style="direction: ltr" required>
            </div>
         </div>
       <div class="row form-group">
         <div class="col-lg-4">
