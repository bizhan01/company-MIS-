      ...
      <div class="col-md-4">
        <div class="box bg-white user-1">
          ...
          <div class="u-content">
            ...
            <p class="text-muted pb-0-5">مدیر مالی</p>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-success mb-2">
          ...
          <div class="t-content">
            ...
            <h6 class="text-uppercase">مصارف روزمره</h6>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-primary  mb-2">
          ...
          <div class="t-content">
            <h1 class="mb-1">{{$salaries}}</h1>
            <h6 class="text-uppercase">معاشات</h6>
          </div>
        </div>
      </div>
      <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="box box-block tile tile-2 bg-danger mb-2">
          ...
          <div class="t-content">
            <h1 class="mb-1">{{$taxes}}</h1>
            <h6 class="text-uppercase">مالیات</h6>
          </div>
        </div>
      </div>
    </div>
